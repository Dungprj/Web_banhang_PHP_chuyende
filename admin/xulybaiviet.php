...
// Định nghĩa mảng các phần mở rộng hợp lệ trước khi thực hiện kiểm tra
...
if (isset($_POST['thembaiviet'])) {
    ...
    if (in_array($file_extension, $allowed_extensions)) {
        // Chỉ chấp nhận file với định dạng png, jpg, jpeg
        ...
        echo "Định dạng file không hợp lệ. Chỉ chấp nhận .png, .jpg, .jpeg!";
    }
    ...
    if ($hinhanh == '') {
        // Nếu không có hình ảnh mới thì chỉ cập nhật thông tin khác
        ...
        if (in_array($file_extension, $allowed_extensions)) {
            // Nếu hình ảnh hợp lệ thì upload và cập nhật
            move_uploaded_file($hinhanh_tmp, $path.$hinhanh);
                ...
                <table class="table table-bordered ">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="?quanly=capnhat&capnhat_id=<?php echo $row_bv['baiviet_id'] ?>">Cập nhật</a> |
                                <a href="?xoa=<?php echo $row_bv['baiviet_id'] ?>">Xóa</a>
                            </td>
                        </tr>
                    <?php
                    }
