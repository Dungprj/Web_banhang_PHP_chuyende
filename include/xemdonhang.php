					...
					<div class="wrapper">
						<!-- first section -->
							...
							<div class="col-md-12">
								...
								$sql_select = mysqli_query($con,"SELECT * FROM tbl_giaodich, tbl_sanpham WHERE tbl_giaodich.sanpham_id = tbl_sanpham.sanpham_id AND tbl_giaodich.khachhang_id='$id_khachhang' GROUP BY tbl_giaodich.ngaythang DESC"); 
								?> 
								<table class="table table-bordered ">
									...
									<tr>
										...
										<td><a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>#chitiet">Xem chi tiết</a></td>
										<td><?php 
							...
							<div class="col-md-12">
								...
								?> 
								<table id="chitiet" class="table table-bordered ">
									<tr>
										<th>Thứ tự</th>
										<th>Mã giao dịch</th>
										<th>Tên sản phẩm</th>
